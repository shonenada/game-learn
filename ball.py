...
def run():
    ...
    ballpng = Image.open('img/ball.png')
    mousepng = Image.open('img/mousecursor.png')

    ball_image = pygame.image.frombuffer(ballpng.tostring(), ballpng.size, ballpng.mode).convert_alpha()
    mouse_image = pygame.image.frombuffer(mousepng.tostring(), mousepng.size, mousepng.mode).convert_alpha()
